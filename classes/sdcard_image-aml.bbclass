...
IMAGE_TYPEDEP_aml-sdimg = "${SDIMG_ROOTFS_TYPE}"
...
# SD card image name
SDIMG = "${DEPLOY_DIR_IMAGE}/${IMAGE_NAME}.rootfs.aml-sd.img"
...
IMAGE_CMD_aml-sdimg () {
	...
	mkfs.vfat -n "${BOOTDD_VOLUME_ID}" -S 512 -C ${WORKDIR}/boot.img $BOOT_BLOCKS
        ...
        mcopy -i ${WORKDIR}/boot.img -s ${DEPLOY_DIR_IMAGE}/boot.dtb ::boot.dtb
